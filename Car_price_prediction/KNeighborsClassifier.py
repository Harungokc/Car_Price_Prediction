...
# Tahmin için kullanıcı verisini hazırlama ve ölçeklendirme
giris_verisi = np.array([[Uretim_yili, Kilometre, Yakit_Tipi, Boya_Degisen]])
giris_verisi = sc.transform(giris_verisi)
